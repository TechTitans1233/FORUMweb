function criarMenuLateral() {
  ...
  aside.style.color = '#ccc';
  aside.style.padding = '1rem';
  aside.style.height = '100vh';
  aside.style.overflowY = 'auto';
  aside.style.borderRight = '1px solid #2c2c2c';
  ...
  header.innerHTML = `
    <div class="logo-container">
      <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" class="logo-horus" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"  xml:space="preserve">
            <style type="text/css">
                .st0{fill: white;}
            </style>
            <g class="logo-horus">
                <path class="logo-horus" d="M471.742,248.28c-7.719-1.536-61.871-17.541-87.135-30.171c-40.959-20.482-84.04-48.227-157.872-48.227
                ...
                <path class="logo-horus" d="M168.995,257.807c0,31.877,25.852,57.732,57.74,57.732c31.884,0,57.736-25.856,57.736-57.732
                    c0-31.891-25.851-57.74-57.736-57.74C194.847,200.068,168.995,225.916,168.995,257.807z"/>
                <path class="logo-horus" d="M452.492,150.827C395.436,131.8,317.85,73.76,224.025,68.349C130.204,62.931,67.05,99.027,9.314,135.116
      ...
      <div class="logo-texts">
        <h1 class="app-name">Hórus</h1>
        <p class="app-description">Disaster Warning System</p>
      </div>
    </div>
  `;
  ...
  const botoes = [
    { texto: 'Início', icone: 'fa-home', link: '/forum' },
    { texto: 'Perfil', icone: 'fa-user', link: '/perfil' },
    { texto: 'Configurações', icone: 'fa-cog', link: '/configuracoes' },
    { texto: 'Notificações', icone: 'fa-bell', link: '/configuracoes' },
    { texto: 'Sair', icone: 'fa-sign-out-alt', link: '/logout' }
  ];

  botoes.forEach(({ texto, icone, link }) => {
